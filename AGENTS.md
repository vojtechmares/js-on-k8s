...
- `examples/` holds standalone apps (full, frameworks/*, nextjs, tanstack-start, private-packages, telemetry); keep them in sync with the recipes. Each has its own Dockerfile and lockfile.
